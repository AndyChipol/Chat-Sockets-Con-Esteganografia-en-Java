 ...
 */
public class UsuarioUno extends javax.swing.JFrame {
    ...
    ServerSocket servidorImagen  = null;    
    ...
    public UsuarioUno() {
        ...
        Thread main = new Thread(new Runnable(){
            public void run(){
                    try {
                    servidor = new ServerSocket(9800);                  
                    while(true){
        ...
        Thread mainImage = new Thread(new Runnable(){
            public void run(){
                    try {
                    servidorImagen = new ServerSocket(9886);                  
                    while(true){
                        System.out.println("srvImagen Connect");
                        socketImagen = servidorImagen.accept();
                        leerImagen();
                        escribeImagen();
                    }
        ...
        Thread hilo = new Thread(new Runnable(){
            public void run(){
                try {
                    ...
                    String le ; 
                    imgEnviar2.addActionListener(new ActionListener(){
                        @Override
                        public void actionPerformed(ActionEvent ae) {
                            estego(link,imgTexto.getText());
                            img.println("C:\\Users\\andy_\\Desktop\\UsuarioUno.png");
                        }
                    });
                } catch (Exception e) {
                    e.printStackTrace();
      ...
      //  System.out.println("no funciona");
        ...
        //            System.out.print("funciona");
                    ...
                    enviar.addActionListener(new ActionListener(){
                        @Override
                        public void actionPerformed(ActionEvent ae) {
                            chat.append("\n"+"Usuario 1: "+mensajeNormal.getText());
    ...
    public static String visualizar(int numLet){
        String binarioEstego = "";
         try{
            File imagen = new File("C:\\Users\\andy_\\Desktop\\UsuarioDos.png");    
    ...
    public static void estego(String link,String prueba){
        ...
        for(int y = 0; y < height; y++){
          for(int x = 0; x < width; x++){
            ...
            ImageIO.write(img,"png",new File("C:\\Users\\andy_\\Desktop\\UsuarioUno.png"));
    ...
    public static boolean verificarClave(String clave){
         String claveReal = "00000111000001110000011100000111000001110000011100000111000001110000011100000111";;
         String bin = "";
    ...
    */    
    ...
    private void initComponents() {
        ...
        imgEnviar1 = new javax.swing.JButton();
        ...
        imgEnviar2 = new javax.swing.JButton();
        jScrollPane1 = new javax.swing.JScrollPane();
        chat = new javax.swing.JTextArea();
        image = new javax.swing.JLabel();

        imgEnviar1.setBackground(new java.awt.Color(102, 255, 102));
        imgEnviar1.setText("Enviar");
        imgEnviar1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                imgEnviar1ActionPerformed(evt);
            }
        });
        ...
        jPanel4.setPreferredSize(new java.awt.Dimension(417, 422));

        jTabbedPane2.setToolTipText("");
        jTabbedPane2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jTabbedPane2.setFont(new java.awt.Font("Yu Gothic UI Semibold", 1, 12)); // NOI18N
        jTabbedPane2.setPreferredSize(new java.awt.Dimension(417, 240));

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));

        jScrollPane2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 255, 105), 2));
        ...
        enviar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Componente 5 – 1.png"))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(enviar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        enviarCifrado.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Componente 5 – 1.png"))); // NOI18N
        enviarCifrado.setBorder(null);
        enviarCifrado.setBorderPainted(false);
        enviarCifrado.setContentAreaFilled(false);
        enviarCifrado.setFocusPainted(false);
        enviarCifrado.setFocusable(false);
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(enviarCifrado, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        imgEnviar2.setBackground(new java.awt.Color(102, 255, 102));
        imgEnviar2.setText("Enviar");
        imgEnviar2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                imgEnviar2ActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(imgEnviar2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGap(31, 31, 31))
                    .addGroup(jPanel5Layout.createSequentialGroup()
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addComponent(imgEnviar2, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                                .addComponent(estego, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(32, 32, 32))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
    ...
    private void imgEnviar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_imgEnviar1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_imgEnviar1ActionPerformed

    private void imgEnviar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_imgEnviar2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_imgEnviar2ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UsuarioUno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        //</editor-fold>
        new UsuarioUno().setVisible(true);
        /*String clave = JOptionPane.showInputDialog("Usuario 1 Introduce Clave:");
    ...
    public javax.swing.JButton imgEnviar1;
    public javax.swing.JButton imgEnviar2;
